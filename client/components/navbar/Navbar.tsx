        ...
        <>
            <nav className="w-[100vw] bg-dark-cyan p-[10px_16px] h-[78px] sm:p-[10px_32px] xl:p-[15px_96px] mx-auto 2xl:p-[15px_156px] flex justify-between items-center sticky top-0 z-[20]">
                ...
                <div className="hidden xlg:flex links items-center gap-[25px] lg:gap-[15px] text-white font-popins">
                    ...
                    <div className="group p-[6px_8px] flex justify-center items-center gap-[4px] text-[14px]  duration-200 relative">
                        ...
                        <Image className="group-hover:rotate-90" src={navArrow} alt="Nav Arrow" />
                        <div className="group-hover:grid grid-cols-2 hidden  gap-1 p-1 z-[12] bg-[#10323C] absolute top-[30px]  h-fit left-0 s w-[280%]">
                            <div className="flex flex-col gap-2 items-start col-span-1 " >
                                <h4 className="font-inter text-[14px] text-white font-bold leading-6 px-[9px]">Discover</h4>
                                <div className="w-[100%]">
                                    <Link href="/" className="font-inter text-[14px] font-[400] leading-6 text-white flex items-center p-2 hover:bg-[#1A3C46] ">Fundrasiers</Link>
                    ...
                    <Link href="/" className={`p-[6px_8px] flex justify-center items-center gap-[4px] text-[14px] hover:text-primary-500 duration-200 ${isActiveLink('/faq') ? 'text-primary-500' : 'text-white'}`}>
                        FAQ
                    </Link>
                    <Link href="/" className={`p-[6px_8px] flex justify-center items-center gap-[4px] text-[14px] hover:text-primary-500 duration-200 ${isActiveLink('/about') ? 'text-primary-500' : 'text-white'}`}>
                        About us
                    </Link>
                </div>
                <div className="w-[158px] h-12 nav-buttons flex justify-between items-center gap-[20px] xss:gap-2.5">
                    <button className="w-[78px] bg-gradient-cyan bg-gradient-cyan-hover text-white p-[6px_8px] flex justify-center items-center gap-[4px] text-[14px] rounded-[36px]" onClick={() => router.push(user.email ? "/fundraising" : "/login")}>
                        <span>Start</span>
            ...
            <div className={`mobile-nav pt-[15px] gap-[72px] h-[100vh] overflow-auto fixed z-[100] ${navOpen ? "left-[0px] duration-200" : "-left-[375px] "} top-0 min-w-[375px] xss:w-[100%] xss:min-w-[unset] bg-[#062832] flex items-center text-white flex-col xlg:hidden`}>
                ...
                <div className="links flex flex-col gap-[24px] font-popins w-[210px]">
                    ...
                    <Link href="/" className={`p-[6px_8px] flex justify-center items-center gap-[4px] text-[14px] hover:text-primary-500 duration-200 ${isActiveLink('/') ? 'text-primary-500' : 'text-white'}`} onClick={() => setNavOpen(false)} >FAQ</Link>
                    <Link href="/" className={`p-[6px_8px] flex justify-center items-center gap-[4px] text-[14px] hover:text-primary-500 duration-200 ${isActiveLink('/') ? 'text-primary-500' : 'text-white'}`} onClick={() => setNavOpen(false)} >About Us</Link>
                </div>
            </div>
        </>
    );
